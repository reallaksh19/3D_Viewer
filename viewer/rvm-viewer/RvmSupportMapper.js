...
// Rules are stored in localStorage and applied during conversion plus support symbol rendering.
...
function _buildPanel() {
  ...
  wrap.innerHTML = `
    ...
    <div style="color:#888; margin-bottom:10px; font-size:11px;">
      Map ATT file fields (CMPSUPTYPE, MDSSUPPTYPE) to support kinds used during conversion and 3D symbol rendering.
    </div>
