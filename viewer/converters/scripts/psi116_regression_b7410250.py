...
Step 2 : XML from 1a/1b -> CII using unchanged xml_to_cii.py, compare against SYS-30-B7410250 [CII BENCHMARK].cii.
...
This script does not modify xml_to_cii.py.
"""
...
def main() -> int:
    ...
    out_1a = run_cmd([sys.executable, str(SCRIPT_DIR / 'xml_to_cii.py'), '--input', str(xml_1a), '--output', str(cii_1a)], REPO_ROOT)
    out_1b = run_cmd([sys.executable, str(SCRIPT_DIR / 'xml_to_cii.py'), '--input', str(xml_1b), '--output', str(cii_1b)], REPO_ROOT)
